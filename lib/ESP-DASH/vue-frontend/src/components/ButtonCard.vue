          ...
          <div class="columns is-mobile is-vcentered">
            ...
            <div class="column is-narrow">
              <transition name="btn-fade" mode="out-in">
                <div class="card-icon py-4 px-5 button is-large is-responsive is-success has-text-light" style="cursor: pointer;" v-if="card.value == 1" @click="sendClickEvent" key="active">
                ...
                <div class="card-icon py-4 px-5 button is-large is-responsive is-dark has-text-white" style="cursor: pointer;" v-else @click="sendClickEvent" key="idle">
